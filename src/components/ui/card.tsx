...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "bg-[red] text-card-foreground flex flex-col items-start gap-0 border border-border shadow-[0px_1px_4px_0px_rgba(26,26,26,0.05),0px_1px_2px_0px_rgba(26,26,26,0.05)]",
      className
    )}
    {...props}
  />
